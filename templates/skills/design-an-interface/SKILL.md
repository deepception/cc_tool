...
Spawn a small number of sub-agents in parallel using the Agent tool — as many as there are genuinely distinct approaches worth seeing, not a fixed count. Each must produce a **radically different** approach.
